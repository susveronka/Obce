...
<?php 
echo anchor("okres/".$okres[0]['kod'].'/10', '10', ['class'=>'btn btn-primary']);
echo anchor("okres/".$okres[0]['kod'].'/20', '20', ['class'=>'btn btn-primary']);
echo anchor("okres/".$okres[0]['kod'].'/50', '50', ['class'=>'btn btn-primary']);
echo anchor("okres/".$okres[0]['kod'].'/100', '100', ['class'=>'btn btn-primary']); 
